...
// void deleteKafkaConsumerGroups() {
//     const char* command = R"(
//     /home/hss544/kafka/bin/kafka-consumer-groups.sh --bootstrap-server 192.168.0.1:9092 --delete --group Multi
//     )";
...
, "Platooning_Lower",  1,&lower_queue,temp_cnt*50);
    ...
    std::string gapFileName = "Gap_" + std::to_string(car_num) + "_" + "Stream"+ "_" + timestamp + ".txt";
    std::string ratioFileName = "Ratio_" + std::to_string(car_num) + "_" + "Stream" + "_" + timestamp + ".txt";
